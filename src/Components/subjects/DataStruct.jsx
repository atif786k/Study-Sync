...
const DataStruct = () => {
  ...
  const handleSyllabus = () => {
    ...
    link.href = "/Images/StructureSyllabus.png.jpg";
    link.download = "DataStructure_syllabus.pdf";
    link.click();
  };
  const handleQuestionPaper = () => {
    const link = document.createElement("a");
    link.href = "/PDF/Data Structure/QP DataStruct.pdf";
    link.download = "DataStructure_Question_Papers.pdf";
    link.click();
  };
  const handleEBook = () => {
    const link = document.createElement("a");
    link.href = "/PDF/Data Structure/ebook.pdf";
    link.download = "DataStructure_E_Book.pdf";
    link.click();
  };
  return (
    <>
      <div className="net-div animate__animated animate__fadeInUp">
        <h1>Introduction to Data Structures using C</h1>
        <div className="">
          <iframe
            width="700"
            height="355"
            src="https://www.youtube.com/embed/5_5oE5lgrhw?si=PFQwK89DVUWZIJZg"
          ...
          >
            ...
            {isOpen && (
              <div style={{ marginLeft: "10px" }}>
                <img
                  src="/Images/StructureSyllabus.png.jpg"
                  alt="Opened Image"
                  style={{
                    maxWidth: "100%",
                    maxHeight: "80vh",
        ...
        <div className="my-2 text-xl space-y-3 ">
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Data Structure/Unit 1.pdf"
                width="800"
                height="500"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Data Structure/Unit 2.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Data Structure/Unit 3.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Data Structure/Unit 4.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Data Structure/Unit 5.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
        ...
        <div className="extra-material">
          ...
          <ol className="flex flex-col">
            <li>
              <Link
                to="https://www.javatpoint.com/data-structure-tutorial"
                target="_blank"
              >
                JavaPoint Data Structure Theory
              </Link>
            </li>
            <li>
              <Link
                to="https://www.youtube.com/playlist?list=PLu0W_9lII9ahIappRPN0MCAgtOu3lQjQi"
                target="_blank"
              >
                Code With Harry (YouTube playlist) One of the best playlist :
              </Link>
            </li>
            <li>
              <Link
                to="https://www.geeksforgeeks.org/data-structures/"
                target="_blank"
              >
                GFG
              </Link>
