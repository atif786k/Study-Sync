...
const Programming = () => {
  ...
  const handleSyllabus = () => {
    ...
    link.href = "/Images/ProgramSyllabus.png.jpg";
    link.download = "Programming_syllabus.png";
    link.click();
  };
  const handleQuestionPaper = () => {
    const link = document.createElement("a");
    link.href = "/PDF/Programming/QP programming.docx";
    link.download = "Programming_Question_Papers.docx";
    link.click();
  };
  const handleEBook = () => {
    const link = document.createElement("a");
  ...
  return (
    <>
      <div className="net-div animate__animated animate__fadeInUp">
        <h1>Introduction to Computer Programming</h1>
        <div className="">
          <iframe
            width="700"
            height="355"
            src="https://www.youtube.com/embed/eKqY-oP1d_Y?si=sw8M-sKpRKfQg91x"
          ...
          >
            ...
            {isOpen && (
              <div style={{ marginLeft: "10px" }}>
                <img
                  src="/Images/ProgramSyllabus.png.jpg"
                  alt="Opened Image"
                  style={{
                    maxWidth: "100%",
                    maxHeight: "80vh",
        ...
        <div className="my-2 text-xl space-y-3 ">
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Programming/Unit 1.pdf"
                width="800"
                height="500"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Programming/Unit 2.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Programming/Unit 3.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Programming/Unit 4.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
          ...
          <details open className="unit-details">
            ...
            <details>
              ...
              <embed
                src="/PDF/Programming/Unit 5.pdf"
                width="800"
                height="500"
                sandbox="allow-same-origin allow-scripts"
                className="embed-pdf"
        ...
        <div className="extra-material">
          ...
          <ol className="flex flex-col">
            <li>
              <Link
                to="https://www.coursera.org/in/articles/what-is-programming"
                target="_blank"
              >
                Understand what is programming ? by Coursera
              </Link>
            </li>
            <li>
              <Link
                to="https://www.youtube.com/watch?v=ZSPZob_1TOk"
                target="_blank"
              >
                Code With Harry (YouTube playlist)
              </Link>
            </li>
            {/* <li>
              <Link
